            ...
            return (
              <div key={gw} className="flex items-center gap-2 p-2 rounded-xl"
                ...
                <div className="flex-shrink-0">
                  {isDGW && <span className="font-black px-1.5 py-0.5 rounded" style={{fontSize:"clamp(8px,2.2vw,10px)",background:'rgba(16,185,129,0.2)',color:'#10b981'}}>DGW</span>}
    ...
    return (
      <GlassCard className="p-5 mt-4 col-span-2">
        ...
        <div className="space-y-3">
          ...
          {/* Stat glossary - explain what each metric means */}
